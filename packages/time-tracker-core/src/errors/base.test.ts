...
describe('에러 클래스', () => {
    it('UC-ERR-001: TimeTrackerError: name, code, message', () => {
    ...
    it("UC-ERR-002: ValidationError: name='ValidationError', code='VALIDATION_ERROR', field", () => {
    ...
    it('UC-ERR-003: StateTransitionError: from_status, to_status, 기본 message', () => {
