<script lang="ts">
  ...
  function handleChangeServer(): void {
    ...
    const to_v5 = v5_text_mode
      ? v5_value
      : parsed.current_server + v5_value;
    const to_v3 = v3_text_mode
      ? v3_value
      : parsed.current_server + v3_value;
...
<Section title="EC Server Manager">
  ...
  <Button fullWidth onclick={handleChangeServer}>
    Click
  </Button>
</Section>
