...
export const server_ui = {
    ...
    set v3_value(v: string) {
        _v3_value = v;
    },

    get v5_text_mode() {
        return _v5_text_mode;
    },
    set v5_text_mode(v: boolean) {
        _v5_text_mode = v;
    },

    get v3_text_mode() {
        return _v3_text_mode;
    },
    set v3_text_mode(v: boolean) {
        _v3_text_mode = v;
    },
};
 ...
 */
export function initializeServerUi(parsed: ParsedUrl): void {
