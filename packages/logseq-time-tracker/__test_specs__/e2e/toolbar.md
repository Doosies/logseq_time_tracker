...
#### UC-E2E-010: Toolbar 일시정지 시 사유 모달 후 재개 버튼이 보인다

- **Given**: Toolbar에서 잡이 진행 중이다
- **When**: 일시정지 버튼 클릭 → 사유 입력 → 확인
- **Then**: 재개 버튼이 표시된다
- **Phase**: 3
- **테스트 레벨**: E2E

#### UC-E2E-011: Toolbar 완료 시 사유 모달 후 활성 작업 없음이 표시된다

- **Given**: Toolbar에서 잡이 진행 중이다
- **When**: 완료 버튼 클릭 → 사유 입력 → 확인
- **Then**: "활성 작업 없음"이 표시된다
- **Phase**: 3
- **테스트 레벨**: E2E
