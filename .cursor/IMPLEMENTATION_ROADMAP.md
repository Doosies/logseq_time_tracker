...
```bash
mkdir -p .cursor/skills/developer
mkdir -p .cursor/skills/qa
mkdir -p .cursor/skills/docs
mkdir -p .cursor/skills/planner
...
**파일**: `.cursor/skills/developer/code-implementation.md`
...
**파일**: `.cursor/skills/main/task-classifier.md`
...
```bash
mkdir -p .cursor/skills/orchestrator
```
...
```bash
mkdir -p .cursor/skills/meta/system
```
...
```bash
mkdir -p .cursor/skills/meta/mcp
...
### Phase 2 롤백
```bash
rm -rf .cursor/skills/developer
rm -rf .cursor/skills/qa
rm -rf .cursor/skills/docs
rm -rf .cursor/skills/planner
rm -rf .cursor/skills/shared
```

### Phase 3 롤백
```bash
rm -rf .cursor/rules
rm -rf .cursor/skills/main
```

### Phase 4 롤백
```bash
rm -rf .cursor/skills/orchestrator
...
### Phase 6 롤백
```bash
rm -rf .cursor/skills/meta/system
rm -rf .cursor/metrics/improvements
```

### Phase 7 롤백
```bash
rm -rf .cursor/skills/meta/mcp
