...
| 문서                  | 섹션                           | 참조 내용                                       |
| --------------------- | ------------------------------ | ----------------------------------------------- |
| `02-data-pipeline.md` | §3 커밋 그룹핑                 | LogicalChangeUnit, 그룹핑 알고리즘, 조건 테이블 |
...
| `src/processing/grouper.ts`              | 커밋 그룹핑 (LogicalChangeUnit)       |
...
- `LogicalChangeUnit` — `02-data-pipeline.md` §3-0-3
